...
function CtaSection({}: Props) {
  return (
      <div className={`${classes.cta} flex sm:flex-col lg:flex-row gap-4 bg-darkGray p-8 justify-between h-[32rem]  items-center`}>
          ...
          <div className=" max-w-3xl z-50 flex flex-col gap-2 py-2">
              ...
              <button className="bg-purple sm:w-full lg:max-w-xs w-full p-3 z-50 rounded-lg text-base text-white">Explore Properties</button>
