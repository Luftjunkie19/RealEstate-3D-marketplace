...
return (<>
<div className={`h-fit w-full ${openedChat ? 'lg:max-w-44 xl:max-w-52 max-h-32' : 'lg:max-w-52 lg:max-h-64 xl:max-w-xs '} sm:max-w-36 sm:max-h-36 overflow-hidden relative top-0 left-0`}>
