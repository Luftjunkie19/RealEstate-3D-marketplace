...
return (<>
<div className={`h-fit w-full ${openedChat ? 'lg:max-w-44 xl:max-w-52 3xl:max-w-60 3xl:max-h-40 max-h-28' : 'lg:max-w-52 lg:max-h-64 xl:max-w-xs '} sm:max-w-36 sm:max-h-24 overflow-hidden relative top-0 left-0`}>
  ...
  <Image src={(participant.metaData as any).picture ? (participant.metaData as any).picture : DefaultImage} className="w-full h-24 object-cover rounded-lg" width={64} height={64} alt=""/>}
