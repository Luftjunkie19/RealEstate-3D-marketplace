...
function ChatDrawer({shownChat, closeChat, }: Props) {
  ...
  return (
    <div className={`sm:fixed lg:static duration-500 rounded-l-lg h-screen top-0 ${shownChat ? 'right-0 block' : '-right-full hidden'} bg-darkGray/95 max-w-xs w-full transition-all`}>
