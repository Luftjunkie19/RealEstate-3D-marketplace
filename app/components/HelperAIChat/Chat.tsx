...
// }, [messages]);
  ...
  return (
    <div className={`${openState ? 'flex' : 'hidden'} transition-all z-[99999999999]  flex-col gap-6 fixed bottom-10 right-6 w-full max-h-96 h-full bg-purple rounded-lg max-w-xs`}>
