...
const {meeting}=useMeeting();
  ...
  return (
    ...
    <div>
     ...
     {participant.metaData && (participant.metaData as any).avatar_url && <Image width={200} height={200} src={(participant.metaData as any).avatar_url} className='sm:w-16 sm:h-16 md:w-60 rounded-2xl md:h-44 object-fill' alt=''  />} 
      </>)}
